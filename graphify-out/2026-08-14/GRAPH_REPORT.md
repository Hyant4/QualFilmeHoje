...
## Summary
- 543 nodes · 1032 edges · 61 communities (39 shown, 22 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 110 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99411e80`
...
Cohesion: 0.07
Nodes (38): dict, HTTPRedirectHandler, ExternalResponseError, NoRedirectHandler, open_json(), Exception, Leitura JSON limitada, sem encaminhar credenciais em redirects., A resposta externa nao e JSON confiavel dentro dos limites locais. (+30 more)

### Community 3 - "tmdb.py"
Cohesion: 0.08
Nodes (42): csrf_exempt, get_library(), is_favorite(), _build_title_payload(), _discovery_candidates(), _fetch_title_extras(), _get(), get_genres() (+34 more)
...
Cohesion: 0.22
Nodes (16): build_generation_context(), build_home_context(), filter_options_context(), _genre_name(), _landing_context(), parse_ascii_int(), parse_filters(), _parse_min_release_year() (+8 more)
...
### Community 52 - "Title"
Cohesion: 0.32
Nodes (8): FavoriteAdmin, GenerationAdmin, TitleAdmin, Favorite, Generation, Meta, Title, register
...
Cohesion: 0.32
Nodes (5): create_user(), Factories pequenas para manter os testes focados no comportamento relevante., tmdb_title_payload(), TestCase, TestFactoriesTests
...
- **Why does `Title` connect `Title` to `SEOMetadataTests`, `MovieViewTests`, `library.py`, `home.py`, `AuthenticationTests`, `TitleSitemap`, `models.py`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `MovieViewTests` connect `MovieViewTests` to `Title`, `models.py`, `create_title`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `AuthenticationTests` connect `AuthenticationTests` to `Title`, `models.py`, `create_title`?**
